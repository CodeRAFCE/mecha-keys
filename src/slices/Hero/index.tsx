  ...
  return (
    ...
    >
      ...
      <div className="hero-content absolute inset-x-0 top-0 h-dvh">
        <Bounded
          fullWidth
          className="md:left[8vw] absolute inset-x-0 top-18 md:top-24 md:left-[8vw]"
        >
          <PrismicRichText
        ...
        >
          <div className="max-w-md">
            <PrismicRichText
              ...
              components={{
                heading2: ({ children }) => (
                  <h2 className="hero-body font-bold-slanted mb-1 text-4xl uppercase lg:mb-2 lg:text-6xl">
                    {children}
                  </h2>
                ),
              }}
          ...
          <button className="font-bold-slanted group flex w-fit cursor-pointer items-center justify-center rounded bg-[#01A7E1] px-3 py-1 text-2xl uppercase transition disabled:grayscale">
            {slice.primary.buy_button_text}
            <span className="pl-2 transition group-hover:translate-x-1">
              {">"}
            </span>
          </button>
        </Bounded>
